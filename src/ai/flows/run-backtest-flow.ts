...
Strategy Rules: {{{jsonStringify rules}}}

1.  **Generate a plausible daily equity curve** over 2 years (approx 500 trading days). The curve should reflect the provided strategy rules. For example, a simple momentum strategy (buy high, sell higher) might perform well in a trending market but poorly in a volatile one. A value strategy (buy low RSI) might do the opposite.
